			...
			<div class="timeline">
				...
				<div class="photo-display post" id="post-{$post.postid}">
					...
					<div class="opt-group btn-group-justified">
						...
						{/if}
						{if $post.comments == 0}
						<a href="post_group_display.php?user-id={$id}&post-id={$post.postid}&group-id={$group_id}" class="btn btn-default post-opt"><span class="glyphicon glyphicon-comment"></span> Comment <span class="badge">0</span></a>
						{else}
